...
import type { ConsultationFormData, Medicine } from "../../types/consultation.types";
...
const PrescribedMedicinesCard = ({ formData, setFormData }: PrescribedMedicinesCardProps) => {
  ...
  return (
    <Card className="border border-border shadow-sm">
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle className="text-lg font-semibold">Prescribed Medicines</CardTitle>
        ...
        {formData.medicines.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-3 py-16">
            ...
            <div className="space-y-1 text-center">
              ...
              <p className="text-sm text-muted-foreground">Add prescribed medicines for the patient</p>
            </div>
          </div>
        ) : (
                  ...
                  <TableRow key={index}>
                    <TableCell>
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">{medicine.medicineCategory}</span>
                      </div>
                    </TableCell>
